									...
									<div class="row mb-5">
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="my-apartment-county" value="<?php echo e($address['county']); ?>" placeholder="County">
											</div>
										</div>
										...
										<div class="col-lg-6 col-md-6 col-sm-12">
											<div class="form-group">
												...
												<select class="form-control" id="my-apartment-city">
												  ...
												  ?>
												    <option value="<?php echo e($c); ?>"<?php echo e($ss); ?>><?php echo e($c); ?></option>
												  <?php
												   }
												  ?>
												</select>
