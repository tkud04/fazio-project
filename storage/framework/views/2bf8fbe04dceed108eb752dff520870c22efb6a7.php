	<!-- ============================ Special Search Start ================================== -->
			<section class="alert-wrap pt-5 pb-5" style="background:#be831d url(<?php echo e(asset('img/bg-new.png')); ?>);">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12 col-md-12">
						 <form method="post" action="<?php echo e(url('ssf')); ?>" id="ssf-form">
							 <?php echo csrf_field(); ?>
			...
			<!-- ============================ Newsletter End ================================== -->			
<?php /**PATH C:\bkupp\lokl\repo\fazio-project\resources\views/special-search-filter.blade.php ENDPATH**/ ?>