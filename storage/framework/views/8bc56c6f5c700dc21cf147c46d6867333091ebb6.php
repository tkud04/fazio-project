							...
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul>
										...
										<li><a href="<?php echo e(url('bye')); ?>"><i class="ti-power-off"></i>Log Out</a></li>
									</ul>
								</div>
								
							</div>
						</div><?php /**PATH C:\bkupp\lokl\repo\fazio-project\resources\views/student-dashboard-sidebar.blade.php ENDPATH**/ ?>