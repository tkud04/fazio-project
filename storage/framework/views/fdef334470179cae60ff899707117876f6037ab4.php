...
<div class="order-2 col-lg-4 col-md-12 order-lg-1 order-md-2">
							...
							<div class="exlip-page-sidebar">
								...
								<div class="sidebar-widgets">
									...
									<div class="form-group">
									   <label>County:</label>
										<div class="input-with-icon">
											<input id="guest-apt-sidebar-county" name="county" value="<?php echo e($apf['county']); ?>" type="text" class="form-control" placeholder="County">
									...
									<div class="form-group">
									   <label>City:</label>
										<div class="input-with-icon">
											<select id="guest-apt-sidebar-city" name="city" class="form-control">
												<option value="">Select city</option>
												<?php
												foreach($cities as $c)
												{
												  $ss = $apf['city'] == $c ? " selected='selected'" : "";
												?>
												<option value="<?php echo e($c); ?>"<?php echo e($ss); ?>><?php echo e(ucwords($c)); ?></option>
												<?php
												}
												?>
											</select>
						...
						<!-- Sidebar End --><?php /**PATH C:\bkupp\lokl\repo\fazio-project\resources\views/student-apt-sidebar.blade.php ENDPATH**/ ?>